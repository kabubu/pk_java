...
public class VanCarSimulator {
    ...
    // ODP tu mnie zagiales, wiem ze static jest niezalezny od obiektu klasy
    ...
    public VanCarSimulator() {
        ...
        //OK w sensie ze gdy mamy klase i w niej zdefiniowana jakas property to dobieramy sie do niej za pomoca obiekt.getDanaProperty() a w przypadku zmiennej klasowej (statycznej property)
        // robimy to za pomoca NazwaKlasy.nazwaZmiennej, czyli mozemy tak jak ponizej podzialac dla pewnosci:
    ...
    public static void main(String[] args) {
        //a tutaj ustawiamy property na obiekcie klasy
...
//        Vehicles van0 = new VanCar(); // chcemy stworzyc budowanie Van'ow z defaultowymi parametrami?
        ...
        Vehicles van = new VanCar(TypNadwozia.HATCHBACK, 51231232, 777777, 777777, 777777, 777777, 777777, true); //czy moge miec mozliwosc stworzenia takiego auta?
        ...
        Vehicles van2 = new VanCar(TypNadwozia.SEDAN, 1, 2, 3, 4, 5, 6, true);  //poprawilem tamte klasy i chyba dziala jak nalezy
        ...
        // OK - poki co tym sie nie przejmujemy - na dluzsza mete bedzie trzeba ogarnac co na czym wywolujemy aby mialo sens logiczny
    }
}
